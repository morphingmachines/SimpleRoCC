...
object ivys {
  ...
  val cv1 = ^.playground.build.ivys.cv1
  val sv1 = ^.playground.build.ivys.sv1
  val playjson = ^.playground.build.ivys.playjson
}
...
object simpleRoCC
  ...
  override def moduleDeps = super.moduleDeps ++ Seq(myrocketchip, emitrtl)
